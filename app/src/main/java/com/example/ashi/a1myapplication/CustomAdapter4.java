...
public class CustomAdapter4 extends BaseAdapter {
    ...
    String[] images;
    ImageView imageView;
    public CustomAdapter4(Context context,String[] names, String[] images)
    {
    ...
    public View getView(int i, View convertview, ViewGroup viewGroup) {
        convertview=layoutInflater.inflate(R.layout.customadapter4,null);
           textView=convertview.findViewById(R.id.sponsor_name);
