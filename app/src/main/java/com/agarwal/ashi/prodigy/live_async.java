...
public class live_async  extends AsyncTask<String,Void,String> {
    Context context;
    ListView listView;
...
//    ProgressBar progressBar;
    ...
    //TextView textView;
    public live_async(Context context, ListView listView, String string) {
...
//    }
    ...
    protected void onPostExecute(String s) {
      ...
      //  progressBar.setVisibility(View.INVISIBLE);
        try {
               output1=s.split("#111#");
               list_custom custom=new list_custom(context,output1);
